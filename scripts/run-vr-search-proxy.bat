...
rem Guest tests need Playwright guest recovery or vrgo.search.proxy.guest.bearer.token in secrets.
call mvnw.cmd test -P%ENV_PROFILE% "-Dsurefire.suiteXmlFiles=src/test/resources/testng-vr-search-proxy.xml" %2 %3 %4 %5 %6 %7 %8 %9
exit /b %ERRORLEVEL%
